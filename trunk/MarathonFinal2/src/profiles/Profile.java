 ...
 * @author Lab4
 */
public class Profile extends Application implements athleteNameInterface {
    ...
    public Color getRandomColor(){
        ...
        Color randomColor = new Color(generator.nextDouble(),generator.nextDouble(),generator.nextDouble(), opacity);
        return randomColor;
    }
    @Override
    public void start(final Stage primaryStage) /*throws Exception*/ {
        ...
        drawPerson(root,0);
            ...
            Timeline fiveSecDelay = new Timeline(new KeyFrame(Duration.seconds(2), new EventHandler<ActionEvent>() {
               int playerNum = startingPoint + 1;
            ...
            fiveSecDelay.setCycleCount(numberOfPlayers - 1);
            fiveSecDelay.play();
            fiveSecDelay.setOnFinished(new EventHandler<ActionEvent>() {
